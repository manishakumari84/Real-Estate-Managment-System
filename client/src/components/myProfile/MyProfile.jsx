...
const MyProfile = () => {
  ...
  const handleDeleteProfile = async () => {
    try {
      ...
      await request(`/auth/delete-profile`, "DELETE", options);
      dispatch(logout());
      navigate("/signin");
    } catch (error) {
      setError(true);
                ...
                {listedProperties?.length > 0 ? (
                  listedProperties?.map((listedProperty) => (
                    <div key={listedProperty._id} className={classes.property}>
                      ...
                      >
                        <img
                          src={`http://localhost:5000/images/${listedProperty?.img}`}
                          alt=""
                        />
                      </Link>
                ...
                {bookmarkedProperties?.length > 0 ? (
                  bookmarkedProperties?.map((bookmarkedProperty) => (
                    ...
                    >
                      ...
                      >
                        <img
                          src={`http://localhost:5000/images/${bookmarkedProperty?.img}`}
                          alt=""
                        />
                      </Link>
                      <div className={classes.details}>
