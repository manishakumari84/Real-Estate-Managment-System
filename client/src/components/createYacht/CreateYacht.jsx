...
const CreateYacht = () => {
  ...
  const [metersLong, setMetersLong] = useState("");
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      const newYacht = await request("/yacht", "POST", options, {
        ...body,
        img: filename,
      });
        ...
        <form onSubmit={handleCreate}>
          ...
          <div className={classes.inputBox}>
            ...
            <input
              ...
              type="text"
              name="metersLong"
              onChange={(e) => setMetersLong(e.target.value)}
            />
          </div>
          <div className={classes.inputBoxImage}>
            <label htmlFor="image">
              Photo <AiFillFileImage />
            </label>
            <input
              type="file"
              id="image"
            ...
            />
            {photo && (
              <div style={{ marginTop: "12px" }}>Photo name: {photo.name}</div>
            )}
          </div>
